...
def train(train_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=True):
    ...
    if model_save_path is not None:
        with open(model_save_path, 'wb') as f:
            pickle.dump(knn_clf, f, protocol=2)

    return knn_clf


def predict(face_encoding, knn_clf=None, model_path=None, distance_threshold=0.48):
    """
...
if __name__ == "__main__":
    ...
    classifier = train("face_database_bp", model_save_path="trained_knn_model.clf", n_neighbors=1)
